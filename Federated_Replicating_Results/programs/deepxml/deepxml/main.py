...
def train(model, params):
    ...
    return train_time, model_size, model
...
def inference(model, params):
    ...
    if params.use_pretrained_shortlist:
        pretrained_shortlist = os.path.join(
            params.model_dir, 'tst_shortlist.npz')
    predicted_labels, prediction_time, avg_prediction_time, stats = model.predict(
        data_dir=params.data_dir,
        result_dir=params.result_dir,
        dataset=params.dataset,
    ...
    return predicted_labels, prediction_time, avg_prediction_time, stats
